...
class BoiledTile3 extends StatefulWidget {
  ...
  @override
  State<BoiledTile3> createState() => _BoiledTileState();
}

class _BoiledTileState extends State<BoiledTile3> {
  SaveOrder() {
    FirebaseFirestore.instance
        .collection('โต๊ะ')
        .doc("TB3 : ${widget.MunuID}")
        .set({
