...
import 'package:food_app/tool/table_tile.dart';

class Table2_PriceScren extends StatefulWidget {
  Table2_PriceScren({
    super.key,
  });

  @override
  State<Table2_PriceScren> createState() => _Table2_PriceScrenState();
}

class _Table2_PriceScrenState extends State<Table2_PriceScren> {
  Future<num> _getTotalPrice() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('โต๊ะ')
        .where('table', isEqualTo: 'โต๊ะ 2')
        .get();
  ...
  Future<void> _savePaymentData(num totalPrice) async {
    ...
    print('ลบ Collection "โต๊ะ 2" สำเร็จ');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('โต๊ะ 2')),
      body: StreamBuilder(
