...
class Table4_PriceScren extends StatefulWidget {
  Table4_PriceScren({
    super.key,
  });

  @override
  State<Table4_PriceScren> createState() => _Table4_PriceScrenState();
}

class _Table4_PriceScrenState extends State<Table4_PriceScren> {
  Future<num> _getTotalPrice() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('โต๊ะ')
        .where('table', isEqualTo: 'โต๊ะ 4')
        .get();
  ...
  Future<void> _savePaymentData(num totalPrice) async {
    ...
    print('ลบ Collection "โต๊ะ 4" สำเร็จ');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('โต๊ะ 4')),
      body: StreamBuilder(
