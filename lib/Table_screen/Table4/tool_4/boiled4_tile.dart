...
class BoiledTile4 extends StatefulWidget {
  ...
  @override
  State<BoiledTile4> createState() => _BoiledTileState();
}

class _BoiledTileState extends State<BoiledTile4> {
  SaveOrder() {
    FirebaseFirestore.instance
        .collection('โต๊ะ')
        .doc("TB4 : ${widget.MunuID}")
        .set({
