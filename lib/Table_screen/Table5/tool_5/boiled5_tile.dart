...
class BoiledTile5 extends StatefulWidget {
  ...
  @override
  State<BoiledTile5> createState() => _BoiledTileState();
}

class _BoiledTileState extends State<BoiledTile5> {
  SaveOrder() {
    FirebaseFirestore.instance
        .collection('โต๊ะ')
        .doc("TB5 : ${widget.MunuID}")
        .set({
