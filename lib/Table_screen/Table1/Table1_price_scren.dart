...
class Table1_PriceScren extends StatefulWidget {
  Table1_PriceScren({
    super.key,
  });

  @override
  State<Table1_PriceScren> createState() => _Table1_PriceScrenState();
}

class _Table1_PriceScrenState extends State<Table1_PriceScren> {
  Future<num> _getTotalPrice() async {
    QuerySnapshot snapshot = await FirebaseFirestore.instance
        .collection('โต๊ะ')
        .where('table', isEqualTo: 'โต๊ะ 1')
        .get();
  ...
  Future<void> _savePaymentData(num totalPrice) async {
    ...
    print('ลบ Collection "โต๊ะ 1" สำเร็จ');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('โต๊ะ 1')),
      body: StreamBuilder(
