...
class BoiledTile extends StatefulWidget {
  ...
  @override
  State<BoiledTile> createState() => _BoiledTileState();
}

class _BoiledTileState extends State<BoiledTile> {
  bool hasFood = true;
  bool nofood = false;
  @override
...
//           Container(
//               width: 140,
//               child: Image.network(widget.itemPhoto!, fit: BoxFit.contain)),